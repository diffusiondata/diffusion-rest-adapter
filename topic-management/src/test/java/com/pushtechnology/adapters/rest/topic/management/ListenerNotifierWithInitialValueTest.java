...
/**
 * Unit tests for {@link ListenerNotifierWithInitialValue}.
 *
 * @author Matt Champion 13/05/2017
 */
public final class ListenerNotifierWithInitialValueTest {
    @Mock
    ...
    public void postConditions() {
        verifyNoMoreInteractions(binary, topicCreationListener);
    }

    @Test
    public void notifyTopicCreated() throws Exception {
        final ListenerNotifier listenerNotifier = new ListenerNotifierWithInitialValue(
        ...
        verify(topicCreationListener).onTopicCreated(serviceConfig, endpointConfig, binary);
    }
    ...
    public void notifyTopicCreationFailed() throws Exception {
        ...
        verify(topicCreationListener).onTopicCreationFailed(serviceConfig, endpointConfig, binary, INVALID_DETAILS);
    }
}

...
/**
 * Implementation of {@link ListenerNotifier} for topics without an initial value.
 *
 * @author Matt Champion 13/05/2017
 */
/*package*/ final class ListenerNotifierWithoutInitialValue implements ListenerNotifier {
     ...
     * Constructor.
     */
    /*package*/ ListenerNotifierWithoutInitialValue(
    ...
    public void notifyTopicCreated() {
        topicCreationListener.onTopicCreated(serviceConfig, endpointConfig);
    }

    @Override
    public void notifyTopicCreationFailed(TopicAddFailReason reason) {
        topicCreationListener.onTopicCreationFailed(serviceConfig, endpointConfig, reason);
    }
}

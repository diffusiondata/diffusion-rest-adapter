 ...
 */
public final class EndpointPollHandlerFactory implements PollHandlerFactory<String> {
     ...
     * Constructor.
     */
    public EndpointPollHandlerFactory(
            PollHandlerFactory<JSON> jsonHandlerFactory,
            PollHandlerFactory<Binary> binaryHandlerFactory,
            PollHandlerFactory<String> stringHandlerFactory) {

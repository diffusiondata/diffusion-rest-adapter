...
public final class TopicBasedMetricsReporterTest {
    ...
    public void start() throws Exception {
        ...
        verify(topicControl).addTopic("metrics/publication/requestBytes", INT64);
        verify(topicControl).addTopic("metrics/publication/successBytes", INT64);
        verify(topicControl).addTopic("metrics/publication/failureBytes", INT64);
        ...
        verify(topicControl).addTopic("metrics/publication/meanPublicationBytes", DOUBLE);
    ...
    public void startTwice() throws Exception {
        ...
        verify(topicControl, times(2)).addTopic("metrics/publication/requestBytes", INT64);
        verify(topicControl, times(2)).addTopic("metrics/publication/successBytes", INT64);
        verify(topicControl, times(2)).addTopic("metrics/publication/failureBytes", INT64);
        ...
        verify(topicControl, times(2)).addTopic("metrics/publication/meanPublicationBytes", DOUBLE);

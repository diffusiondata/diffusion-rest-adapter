...
/*package*/ final class EndpointConfigConverter
        implements Converter<com.pushtechnology.adapters.rest.model.v12.EndpointConfig, EndpointConfig> {
    /**
     * The converter.
     */
    ...
    @Override
    public EndpointConfig convert(com.pushtechnology.adapters.rest.model.v12.EndpointConfig endpointConfig) {
        return EndpointConfig
            .builder()
            .name(endpointConfig.getName())
            .url(endpointConfig.getUrl())
            .topicPath(endpointConfig.getTopic())

...
/*package*/ final class SecurityConfigConverter
        implements Converter<com.pushtechnology.adapters.rest.model.v12.SecurityConfig, SecurityConfig> {
    /**
     * The converter.
     */
    ...
    @Override
    public SecurityConfig convert(com.pushtechnology.adapters.rest.model.v12.SecurityConfig securityConfig) {
        ...
        return SecurityConfig
            ...
            .basic(securityConfig.getBasic() == null ?
                ...
                BasicAuthenticationConfig
                   .builder()
                   .userid(securityConfig.getBasic().getPrincipal())
                   .password(securityConfig.getBasic().getCredential())
                   .build())
            .build();
    }
}

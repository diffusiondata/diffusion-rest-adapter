...
/*package*/ final class EndpointConfigConverter
        implements Converter<com.pushtechnology.adapters.rest.model.v11.EndpointConfig, EndpointConfig> {
    /**
     * The converter.
     */
    ...
    @Override
    public EndpointConfig convert(com.pushtechnology.adapters.rest.model.v11.EndpointConfig endpointConfig) {
        return com.pushtechnology.adapters.rest.model.v12.EndpointConfig
            .builder()

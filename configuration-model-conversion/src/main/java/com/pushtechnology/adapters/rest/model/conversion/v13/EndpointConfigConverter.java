...
/*package*/ final class EndpointConfigConverter
        implements Converter<com.pushtechnology.adapters.rest.model.v13.EndpointConfig, EndpointConfig> {
    /**
     * The converter.
     */
    ...
    @Override
    public EndpointConfig convert(com.pushtechnology.adapters.rest.model.v13.EndpointConfig endpointConfig) {

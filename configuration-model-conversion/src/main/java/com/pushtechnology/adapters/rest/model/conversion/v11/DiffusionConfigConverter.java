...
/*package*/ final class DiffusionConfigConverter
        implements Converter<com.pushtechnology.adapters.rest.model.v11.DiffusionConfig, DiffusionConfig> {
    /**
     * The converter.
     */
    ...
    @Override
    public DiffusionConfig convert(com.pushtechnology.adapters.rest.model.v11.DiffusionConfig diffusionConfig) {

...
/**
 * Unit tests for {@link BinaryUpdateContext}.
 *
 * @author Push Technology Limited
 */
public final class BinaryUpdateContextTest {
    @Mock
    ...
    private BinaryUpdateContext updateContext;

    @Before
    public void setUp() {
        initMocks(this);

        updateContext = new BinaryUpdateContext(session, updater, "a/topic");
    }

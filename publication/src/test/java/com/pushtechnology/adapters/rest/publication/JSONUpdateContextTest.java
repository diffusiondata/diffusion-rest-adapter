...
/**
 * Unit tests for {@link JSONUpdateContext}.
 *
 * @author Push Technology Limited
 */
public final class JSONUpdateContextTest {
    @Mock
    private Session session;
    @Mock
    private TopicUpdateControl.ValueUpdater<JSON> updater;
    @Mock
    private JSON json;

    private JSONUpdateContext updateContext;

    @Before
    public void setUp() {
        initMocks(this);

        updateContext = new JSONUpdateContext(session, updater, "a/topic");
    }
    ...
    public void testPublish() {
        ...
        verify(updater).update("a/topic", json, "a/topic", INSTANCE);
    }
    ...
    public void testRecovery() {
        ...
        updateContext.publish(json);
        verify(updater, never()).update("a/topic", json, "a/topic", INSTANCE);

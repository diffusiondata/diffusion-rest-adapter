...
/**
 * For snapshots of the {@link RESTAdapterClient} for a configuration model.
 *
 * @author Push Technology Limited
 */
public final class RESTAdapterClientSnapshotFactory {
    private static final Logger LOG = LoggerFactory.getLogger(RESTAdapterClientSnapshotFactory.class);

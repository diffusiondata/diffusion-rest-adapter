...
public final class PublicationComponentImpl implements PublicationComponent {
    private static final Logger LOG = LoggerFactory.getLogger(PublicationComponentImpl.class);
     ...
     * Constructor.
     */
    public PublicationComponentImpl(
    ...
    /**
     * @return A new {@link PublicationComponentImpl}
     */
    public static PublicationComponent create(Model model, RESTAdapterClientCloseHandle client) {
